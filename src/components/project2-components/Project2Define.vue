        ...
        >
          ...
          <div>
            <ul>
              ...
              <li>Variety of food choice</li>
              <li>Desire to locate nearest restaurant</li>
              <li>Desire for physical activity</li>
...
import Project2Personas from "../../assets/images/Project2/Project2Personas.jpg";
</script>
